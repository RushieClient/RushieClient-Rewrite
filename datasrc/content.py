...
container.sounds.Add(SoundSet("ri_inactive_move_wakeup", ["rclient/audio/nonactive_wakeup.wv"]))
...
image_rc_hook = Image("rchook", "rclient/rchook.png")
image_rc_fire = Image("rcfire", "rclient/rchammer.png")
image_rc_dummy_actions = Image("rcdumactions", "rclient/rcactions.png")
image_rc_chiller_icon = Image("rcchillericon", "rclient/icons/chillerbotux_size.png")
image_rc_duck_icon = Image("rcduckicon", "rclient/icons/duckicon_size.png")
image_rc_kazio_icon = Image("rckazioicon", "rclient/icons/kazioicon_size.png")
...
container.images.Add(image_rc_hook)
container.images.Add(image_rc_fire)
container.images.Add(image_rc_dummy_actions)
container.images.Add(image_rc_chiller_icon)
container.images.Add(image_rc_duck_icon)
container.images.Add(image_rc_kazio_icon)
...
set_rc_dummy_actions = SpriteSet("rcdumactions", image_rc_dummy_actions, 2, 1)
...
container.spritesets.Add(set_rc_dummy_actions)
...
container.sprites.Add(Sprite("rc_dummy_actions_control", set_rc_dummy_actions, 1, 0, 1, 1))
container.sprites.Add(Sprite("rc_dummy_actions_remember", set_rc_dummy_actions, 0, 0, 1, 1))
