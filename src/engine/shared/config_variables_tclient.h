...
// Translate
MACRO_CONFIG_STR(TcTranslateBackend, tc_translate_backend, 32, "googlegtx", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translate backends (ftapi, libretranslate, googlegtx, fedilab)")
MACRO_CONFIG_STR(TcTranslateTarget, tc_translate_target, 16, "ru", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translate target language (must be 2 character ISO 639 code)")
